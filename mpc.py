...
class MPC(Robot):
    ...
    def __init__(self,parameters,num_obstacles=3):
        ...
        # bound = np.array([(self.Torque_MIN,self.Torque_MAX)]) #,[(self.Torque_MIN,self.Torque_MAX)]
    ...
    def control(self,states,trajectory_position,trajectory_velocity,obstacles_position,obstacles_velocity):
        ...
        res = minimize(self.object_function, MPC.current_inputs, method='SLSQP', bounds= self.bounds)
